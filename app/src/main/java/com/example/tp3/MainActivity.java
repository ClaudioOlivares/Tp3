...
private ArrayList<Inmueble> lista = new ArrayList<>();
    ...
    {
        lista.add(new Inmueble(R.drawable.caba,"Juana Koslay",80000));
        lista.add(new Inmueble(R.drawable.caba2,"Cuchi Corral",180000));
        lista.add(new Inmueble(R.drawable.caba3,"Chosme",233555));
